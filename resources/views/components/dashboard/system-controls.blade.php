...
<div class="w-full lg:w-1/3">
    <div class="flex items-center justify-between p-6 bg-white dark:bg-gray-800 rounded-t-lg shadow-xl border-b border-gray-200 dark:border-gray-700 cursor-pointer collapsible-header"
        data-target="system-controls-content">
        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
            <div class="space-y-4">
                    ...
                    <form method="POST" action="{{ route('toggle.maintenance') }}" class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <label for="maintenance-toggle" class="flex items-center cursor-pointer">
                                ...
                                <div class="relative">
                                    <input type="checkbox" id="maintenance-toggle" name="maintenance_mode"
                                        value="1" class="sr-only" {{ $isMaintenanceMode ? 'checked' : '' }}>
                                    <div class="w-10 h-5 bg-gray-300 dark:bg-gray-600 rounded-full shadow-inner">
                                    </div>
                                    <div
                ...
                @if (auth()->user() && auth()->user()->role === 'Owner')
                    <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg shadow-xl">
                        <h4 class="text-base font-medium mb-2">Gebruikersbeheer</h4>
                        <a href="{{ route('users.index') }}"
                            class="w-full px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition duration-150 flex items-center justify-center shadow-xl">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
